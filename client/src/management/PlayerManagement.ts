...
export class PlayerManagement{
    ...
    public addPlayer(scene:Phaser.Scene,imageManagement:ImageManagement,player:object,socket:any,wildPokemonList:Array<WildPokemon>){
    ...
    public addOtherPlayer(scene:Phaser.Scene,imageManagement:ImageManagement,player:object,socket:any,wildPokemonList:Array<WildPokemon>){
        player['playerObj'] = new Player(
